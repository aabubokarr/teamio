  ...
  const initialPosts: Post[] = [
    {
      ...
      type: "personal",
      content:
        "Finished the first prototype today! Check out the interactive design specs for our new mobile navigation layout.",
      image:
    ...
    },
    {
      ...
      type: "team",
      content:
        "We're launching the new campaign next Monday. All systems are green and test coverage is at 98%. Huge kudos to engineering!",
      likes: 142,
      comments: 32,
      shares: 12,
    ...
    },
    {
      ...
      type: "achievement",
      content:
        "Congratulations to Maya for completing her first year with the team! 🎉 Thank you for bringing such incredible creativity and positivity to Teamio.",
      image:
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-base sm:text-lg leading-relaxed text-slate-600">
            Share updates, celebrate wins, exchange ideas, and stay connected
            with the people you work with — in a professional social timeline.
          </p>
        </div>

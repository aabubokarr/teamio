    ...
    <footer className="border-t border-slate-200/80 bg-slate-50/50 pt-14 pb-8">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-12 gap-8 pb-12 border-b border-slate-200/80">
          ...
          <div className="col-span-12 lg:col-span-4">
            ...
            <p className="mt-4 text-xs sm:text-sm text-slate-500 leading-relaxed max-w-sm">
              Social networking for people who work. Connect with your team,
              share ideas, manage tasks, plan your schedule, and get things done
              together.
            </p>
            ...
            <div className="mt-6 flex items-center gap-3">
              <a
                href="#"
                className="flex h-9 w-9 items-center justify-center rounded-xl bg-white border border-slate-200 text-slate-500 hover:text-indigo-600 hover:border-indigo-300 transition"
              >
          ...
          <div className="col-span-12 lg:col-span-8 grid grid-cols-2 sm:grid-cols-4 gap-6">
            ...
            <div>
              ...
              <ul className="space-y-2.5 text-xs text-slate-600">
                <li>
                  <a href="#story" className="hover:text-indigo-600 transition">
                    About
                  </a>
                </li>
                <li>
        ...
        <p className="mt-8 text-xs text-slate-400">
          Copyright © 2026 Teamio. All rights reserved.
        </p>
      </div>
    </footer>
  );
